...
const faqs = [
  ...
  },
  {
    ...
    a: "В WAVE продавец — живой профиль с постами, Историями и отзывами. Умный AI-поиск понимает запросы на естественном языке, а сделки проходят без выхода из приложения.",
  },
  {
